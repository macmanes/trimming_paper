...
all: 10M.SRR449363_1.fastq 10M.SRR449363_2.fastq  \
...
10M.SRR449363_1.fastq 10M.SRR449363_2.fastq : SRR449363_1.fastq SRR449363_2.fastq
...
10M.left.2.fq 10M.left.5.fq 10M.left.10.fq 10M.left.20.fq 10M.right.2.fq 10M.right.5.fq 10M.right.10.fq 10M.right.20.fq: 10M.SRR449363_1.fastq 10M.SRR449363_2.fastq
	@echo About to start trimming
	for TRIM in 2 5 10 20; do \
		java -Xmx30g -jar $(TRIMMOMATIC) PE \
		-phred33 -threads $(CPU) \
		10M.SRR449363_1.fastq \
		10M.SRR449363_2.fastq \
		10M.$$TRIM.pp.1.fq \
		10M.$$TRIM.up.1.fq \
		10M.$$TRIM.pp.2.fq \
		10M.$$TRIM.up.2.fq \
...
10M.2.Trinity.fasta 10M.5.Trinity.fasta 10M.10.Trinity.fasta 10M.20.Trinity.fasta: 10M.left.2.fq 10M.left.5.fq 10M.left.10.fq 10M.left.20.fq 10M.right.2.fq 10M.right.5.fq 10M.right.10.fq 10M.right.20.fq
	for TRIM in 2 5 10 20; do \
		$(TRINITY)/Trinity.pl --full_cleanup --min_kmer_cov 2 --seqType fq --JM $(MEM)G --bflyHeapSpaceMax $(MEM)G  \
		--left $(RUN) --right $(RUN) --group_pairs_distance 999 --CPU $(CPU) --output 10M.$(TRIM)
	done
